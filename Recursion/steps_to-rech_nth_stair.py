...
#             print("End:", end_index)
#             a=arr[start_index]
#             arr[start_index:end_index]=arr[end_index:start_index:-1]
#             print("End:", arr)
#             arr[end_index]=a            
#         return arr

# s=Solution()
# print(s.reverseInGroups([1, 2, 3, 4, 5], 5, 3))
...
# s=Solution()
# print(s.check([8, 9, 7, 5, 3, 1,], [5, 4, 2, 5, 1, 7], 6))